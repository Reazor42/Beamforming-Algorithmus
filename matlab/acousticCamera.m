...
projectionPlaneDistance = 10;             % Z in meter
projectionPlaneWidth    = 5;             % X in meter
projectionPlaneHeight   = 5;             % Y in meter
projectionPlaneDelta    = 0.05;          % Δ in meter (influences the image size)
samplesPerImage         = 2000;          % N in samples (aka window size, no overlapping)
...
audiowrite("data/sample.wav",data(32,:)/10000.0,sampleRate) % save one test channel to the disk
